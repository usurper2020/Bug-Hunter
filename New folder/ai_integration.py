                                           ...
                                           try:
                                            ...
                                            template_suggestions = []
                                               if self.nuclei_analyzer:
                                                template_suggestions = self.nuclei_analyzer.get_template_suggestions(
                                                    url, technologies
                                                )
                                            ...
                                            return {
                                                ...
                                                logger.error(
                                                    f"Error analyzing website: {str(e)}")
                                                       ...
                                                       def process(self, context: Dict) -> Dict:
                                                        """Process a message context through the AI integration."""
                                                           try:
                                                            ...
                                                            url = url_match.group(
                                                                0) if url_match else context.get("current_url")
                                                            ...
                                                            # If we have a URL and nuclei analyzer, get template suggestions
                                                               if url and self.nuclei_analyzer:
                                                                    ...
                                                                    processed[
                                                                        "template_suggestions"
                                                                    ] = self.nuclei_analyzer.get_template_suggestions(url, [])
                                                                       except Exception as e:
                                                                        processed[
