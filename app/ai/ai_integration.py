...
class AIIntegration:
    ...
    def process(self, context: Dict) -> Dict:
        ...
        try:
            ...
            url = url_match[0] if url_match else context.get("current_url")
    ...
    def _detect_intent(self, message: str) -> str:
        ...
        intent = next((intent for intent, pattern in intents.items() if re.search(pattern, message, re.IGNORECASE)), "general")
        return intent
    ...
    def _extract_entities(self, message: str) -> List[Dict]:
        ...
        entities = [{"type": "url", "value": url.group(0), "position": url.span()} for url in urls]
        ...
        entities.extend({"type": "security_term", "value": term} for term in security_terms if term.lower() in message.lower())
